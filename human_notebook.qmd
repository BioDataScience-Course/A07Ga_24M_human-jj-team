...
```{r test_t_1}
t.test(data = biometry2, masse ~ genre, alternative = "two.sided", conf.level = 0.95,var.equal = TRUE)
```
...
-   H0 : \\overline{activite_physique{F}} - \\overline{activite_physique{H}} = 0

-   H1 : \\overline{activite_physique{F}} - \\overline{activite_physique{H}} \> 0
